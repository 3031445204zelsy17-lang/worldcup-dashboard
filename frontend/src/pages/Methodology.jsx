        ...
        <section className="bg-amber-50 rounded-xl border border-amber-200 p-4">
          ...
          <div className="space-y-3 text-sm text-slate-700">
            ...
            <div className="flex gap-2">
              ...
              <div>
                <b>淘汰赛加时与点球近似处理。</b>
                90 分钟平局后按 30 分钟加时(进球率缩为 1/3)分胜负, 加时仍平才 50/50 点球(近似随机)。
                我们<b>未</b>单独建模淘汰赛的心态/阵容/磨合差异(无阵容数据, 留待实时数据接入)——
                回测显示淘汰赛 90 分钟平局率约 28%, 显著高于小组赛的 20%, 强队也更易被逼平,
                这部分不确定性是足球本身的, 无法靠模型消除。
              </div>
            </div>
          </div>
        </section>
